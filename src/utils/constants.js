...
export default {
  ...
  CONFIG_KEY_ACTIVITIES_RETENTION_DELAY_IN_HOURS: 'ACTIVITIES_RETENTION_DELAY_IN_HOURS',
  ...
  CONFIG_KEY_LTI_CONSUMERS: 'LTI_CONSUMERS',
  CONFIG_KEY_LOGIN_WELCOME: 'LOGIN_WELCOME',
  CONFIG_KEY_DEMO_ACCOUNT: 'DEMO_ACCOUNT',

  CONFIG_KEY_LDAP_SERVER: 'LDAP_SERVER',
  CONFIG_KEY_LDAP_PRINCIPAL: 'LDAP_PRINCIPAL',
  CONFIG_KEY_LDAP_PASSWORD: 'LDAP_PASSWORD',
  CONFIG_KEY_LDAP_SEARCH: 'LDAP_SEARCH',
  CONFIG_KEY_LDAP_ATTRIBUTES: 'LDAP_ATTRIBUTES',
  CONFIG_KEY_LDAP_PASSWORD_ATTRIBUTE_NAME: 'LDAP_PASSWORD_ATTRIBUTE_NAME'
};
