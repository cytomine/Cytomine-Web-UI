...
export default {
  ...
  // ---
  IDLE_DURATION: 120, // if the user does not move their mouse on the page during this duration, the user is considered as inactive - no more ping (expressed in seconds)
  ...
  ANNOTATIONS_MAX_ITEMS_PER_CATEGORY: 20,
};
