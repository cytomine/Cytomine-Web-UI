...
<div class="content-wrapper">
  ...
  <div class="panel" v-if="currentUser.apiEnabled || currentUser.adminByNow"> <!-- QUESTION: remove ? or only show for technical users ? -->
    <p class="panel-heading">
...
export default {
  ...
  data() {
    return {
      ...
      externalEditLink: constants.SSO_LOGIN+'/registration/edit',
    };
  },
  computed: {
