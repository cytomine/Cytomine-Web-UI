...
* Change the value of constants `CYTOMINE_URL` in src/utils/constants.js ; you may also update other constants according to your Cytomine instance or your preferences;
